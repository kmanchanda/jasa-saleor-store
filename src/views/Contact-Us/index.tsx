    ...
    <div className="main-conatct-us">
      <div className="left-container">
        ...
        <span className="heading-desc">
          {" "}
          Har du spørgsmål til vores produkter, hvordan du handler med os eller
          noget helt tredje, så er du altid velkommen til at skrive til os.
        </span>
        <span className="heading-desc">
          Du er også velkommen til at{" "}
          <span style={{ color: "#F5A930" }}>
            kontakte vores medarbejdere direkte her
          </span>
        </span>
              ...
              return (
                <div className="heading-item">
                  ...
                  {subHeading.map((item, indexChild) => {
                    return (
                      <span className="subheading-footer-item">{item}</span>
                    );
                  })}
                </div>
              );
      ...
      <div className="right-container">
        ...
        <button className="send-btn">Send besked</button>
      </div>
    </div>
  );
};
...
const dummyFooterData = [
  {
    ...
    subHeading: ["Marøgelhøj 17", " DK-8520 Lystrup", "Tlf. +45 46 94 90 08"],
  },
  {
